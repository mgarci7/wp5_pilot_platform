...
class SessionManager:
    ...
    async def create_session(self, session_id: str, websocket_send, treatment_group: str, user_name: str = "user", llm_overrides: Optional[Dict] = None) -> SimulationSession:
        ...
        async with self._lock:
            ...
            session = SimulationSession(session_id=session_id, websocket_send=websocket_send, treatment_group=treatment_group, user_name=user_name, llm_overrides=llm_overrides)
